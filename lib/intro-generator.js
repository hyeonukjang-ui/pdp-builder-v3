...
\`\`\`json
${entry.label === 'FAQ' ? '{ "title": "자주 묻는 질문", "faq": [{ "q": "질문", "a": "답변" }] }' : entry.label === '티켓 옵션 비교표' ? '{ "title": "티켓 옵션 비교", "table": [{ "name": "성인", "target": "만 18세 이상", "feature": "모든 전시 입장" }] }' : '{ "title": "string", "paragraphs": ["string", "string"], "background": "white" }'}
\`\`\``,
