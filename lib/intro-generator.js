...
function getCategoryTone(category) {
  const tones = {
    ...
    TICKET_THEME: '밝고 에너지 넘치는 톤. "입장권 1장으로 40개 어트랙션 무제한" 느낌. 즉시 입장, 옵션 비교, 어트랙션 수, 편의 시설 강조.',
    TICKET_TRANSPORT: '간결하고 명확한 톤. "공항에서 시내까지, 탭 한 번이면 끝" 느낌. 사용 편의성, 노선 범위, 가격 절약, 이용방법 강조.',
    TICKET_CITYPASS: '계산적이고 설득적인 톤. "3곳만 방문해도 32,000원 절약" 느낌. 절약 금액, 포함 시설 수, 유효기간, 자유로운 동선 강조.',
    TICKET_EXPERIENCE: '감각적이고 몰입적인 톤. "도쿄 야경이 발아래 펼쳐지는 90분" 느낌. 독특한 경험, 분위기/감성, 시간대, 소요시간 강조.',
    ACTIVITY: '역동적이고 용기를 주는 톤. "초보도 OK, 장비 전부 포함" 느낌. 안전 보장, 초보 가능, 장비 포함, 사진/영상 제공 강조.',
    SERVICE: '감성적이고 프리미엄한 톤. "제주의 빛으로 담아내는 당신만의 순간" 느낌. 결과물 품질, 전문가 포트폴리오, 맞춤화 강조.',
    SEMI_PACKAGE: '실용적이고 안심시키는 톤. "항공+숙박+투어, 이 가격에 다 포함" 느낌. 포함 항목, 가격 대비 가치, 일정 편의, 가성비 강조.',
  };
...
규칙:
- title: 질문형("~해보셨나요?") 또는 수치 포함("3시간 만에 ~") 문장. 최대 25자. "이 상품은"으로 시작 금지.
- subtitle: 상품 핵심 가치 한 줄. 구체적 장소명/숫자 포함 권장. 최대 50자.
- textAlign: "center"
- imagePrompt: AI 이미지 생성용 영어 프롬프트 (선택)
좋은 예: title="로마를 하루 만에 꿰뚫는 법", subtitle="콜로세움부터 바티칸까지, 현지 가이드와 함께"
나쁜 예: title="최고의 여행", subtitle="완벽한 체험을 제공합니다"
\`\`\`json
{ "title": "string", "subtitle": "string", "textAlign": "center", "imagePrompt": "english prompt" }
\`\`\``,
