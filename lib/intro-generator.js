...
코스별 뱃지 + 설명을 한 줄로 배치하는 형태.
규칙:
- title: "투어 코스" 또는 맥락에 맞는 제목. 최대 15자.
- days: 각각:
  - label: 코스 뱃지 텍스트. "출발", "동책코스", "중식", "자유시간" 등 코스/활동 단위. **Day1, Day2 금지 (당일투어일 때).** 여러 날이면 "Day 1" 가능.
  - title: 사용 안 함 (빈 문자열)
  - duration: 소요시간. "약 30분", "1시간" 등 (선택)
  - summary: 해당 코스에서 하는 활동 설명. 최대 40자.
- **데이터에 없는 장소/코스 추가 금지**
\`\`\`json
{ "title": "투어 코스", "days": [{ "label": "출발", "title": "", "duration": "", "summary": "호텔 로비에서 가이드 미팅" }, { "label": "동책코스", "title": "", "duration": "약 1시간", "summary": "전통 시장 탐방 · 현지 간식 체험" }] }
\`\`\``,
