...
const renderer = {
  ...
  ${hasImage
    ? `<div class="mod-hero__img" style="background-image:url('${escapeHtml(image.url)}');${data.imagePosition ? 'background-position:'+escapeHtml(data.imagePosition) : ''}" data-hero-img="${escapeHtml(image.url)}"></div>`
